                                                        ...
                                                        <div class="card joursSpicifier">
                                                            ...
                                                            <div class=" card-header header">
                                                                <div class="NomMed Margin pic prof">
                                                                    ...
                                                                    <p>
                                                                        <a class="popup-jours-annuler closeButton" href="#"><img class="closee" src="img/closee.svg" width="7%" alt=""></a>
                                                                    </p>
                                                                </div>
																...
																?></h4>
                                                                        ...
                                                                        <div class="form-group dureeModification animated fadeInUp" style="display:none;">
                                                                            <form action="changeDur.php" method="POST" id="<?php echo 'DateForm'.$s ?>">
                                                                                <?php
																if($chi>365){?> 
                                                                                    <input type="text" class="typeText" name="interval_prise" placeholder="ajouter une durée du traitement">
                                                                                    <?php
																}else {
																	?>                  <div class="validate-input" data-validate="error" >
                                                                                        <input class="count<?php echo $s ?> input100" type="text" class="typeText" name="interval_prise" value="<?php echo $chi; ?>">
                                                                                        </div>
                                                                                        <?php	
																}?>
                                                                                            <input type="text" style="display:none" name="IDTemps" value="<?php echo $medic['id_temps']; ?>">
                                                    ...
                                                    <script type="text/javascript">
                                                        var s = "<?php echo $inc ?>";
                                                                ...
                                                                <script type="text/javascript">
																		...
																		$('#DateForm'+g).click(function(e){								
																			var def = $(e.target).attr("id");
																			var def = def.substring(8);
																			e.preventDefault();						
																			var form = $("#modifierDuree"+def)[0];
																			var formdata = new FormData(form);
																			...
																			$.ajax({
																				...
																				success:function (data){
                                                                                    if(data.interval == "1"){
                                                                                        ...
                                                                                        // $(".Delay"+def).text(data.intervalVal);
                                                                                    }
