				...
				<div class="row">
					...
					foreach( $controle as $key ) { $i++;
						?>
																				...
																				<span id="<?php echo 'RendVousD'.$i ?>"><?php echo $key['date_conntroles']; ?></span> <span id="<?php echo 'RendVousH'.$i ?>"> <?php echo $key['heure_conntroles']; ?></span>
																				</div></a>	
																				</div>
					<?php
					}
												...
												<div style=" max-width:470px; background:#fff;border-radius:20px; max-height:80vh;">
                                                        ...
                                                        <div class="NomMed Margin pic prof">
															<h3 class="NomdeR nomRendez<?php echo $s; ?>"><?php echo $key['nom_conntroles']	; ?></h3>
																<div  class=" suppButton">
																	<form action="deleteRendez.php" method="POST" id="<?php echo 'deleteRendez'.$s ?>">
																		<input type="text" style="display:none" classe="" name="IDRendez" value="<?php echo $key['id_conntroles']; ?>">
																		<button type="submit" name="suprimerRendez"  style="background:none; border:none;"><img class="supp" id="<?php echo 'suprimerRendez'.$s ?>" src="img/delete.svg" width="4%" alt=""></button>
																	</form>
																</div>

															<p><a id="closee" class="popup-jours-annuler closeButton" href="#"><img class="closee ferme" src="img/closee.svg" width="7%" alt=""></a></p>
                                                        </div>	
                                                    </div>
													<div class="card-body box-shodw coordonne " >
														...
														<div style="margin-top:9%; margin-left:0%; font-size:16px" class="search-form medecin">
															<img  src="img/rendez.svg" width="12%;" alt="">
															<span class=" Margin pic dateHeure2<?php echo $s; ?> spanRndv "><?php echo $key['heure_conntroles']; ?></span>
														</div>  
														<div class="search-form medecin ">
															<img  src="img/alarm.svg" width="7%" alt="">
															<span class="Margin pic spanRndv"><?php echo $key['rappel_conntroles']; ?><?php echo $key['rappel_text']; ?></span>
														</div>
														<div class="search-form medecin ">
													...
													<form  id= "<?php echo 'rendi'.$s ?>">
																<div class="search-form medecin validate-input" data-validate="error" id="<?php echo 'nom_conntroles'.$s?>">
                                                                        ...
                                                                        <div class="form-group unique validate-input" data-validate="error"  id="<?php echo 'heure_conntroles'.$s?>">
                                                                            <input type="text" name="heuresRappel" id="timeRendez" data-toggle="timepicker" class="form-input input100" autocomplete="off" value="<?php echo $key['heure_conntroles']; ?>">
																		</div>
                                                                    </div>
																	...
																	<div class="search-form medecin validate-input" data-validate="error">
																			<img  src="img/alarm.svg" width="7%" alt="">
																			<input type="text" name="timeControle" id="rappel_conntroles<?php echo $s; ?>" data-toggle="timepicker" class="form-input input100" autocomplete="off" value="<?php echo $key['rappel_conntroles']; ?>">
