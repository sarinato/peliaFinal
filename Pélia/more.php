...
<body>
    ...
    <!--================ Start Header Area =================-->
    <header style="background:#038dfe" class="header_area">
        <div class="main_menu">
            ...
            <div class="row ">
                ...
                <div class="single-post row">
                            <div class="">
                                <div class="feature-img">
                                    <img class="img-fluid" src="img/pill.jpg" alt="">
                                </div>
                            </div>
                ...
                <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="img/pill.jpg" width="32%" alt="post">
                                    <div class="media-body">
                                        <a href="blog-details.html">
                                            <h3>Les maladies chronique</h3>
                                        </a>
                                        <p>02 Hours ago</p>
                                    </div>
                                </div>
